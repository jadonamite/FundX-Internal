...
export function constructFqn(address: string, contractName: string): string {
  return `${address}.${contractName}` as const
}

export const FUNDX_CONTRACT_FQN = constructFqn(CONTRACT_ADDRESS, CONTRACT_NAME)
export const REGISTRY_CONTRACT_FQN = constructFqn(CONTRACT_ADDRESS, REGISTRY_CONTRACT_NAME)
export const USDCX_FQN = constructFqn(USDCX_CONTRACT_ADDRESS, USDCX_CONTRACT_NAME)
