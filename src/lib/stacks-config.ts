...
// Utility function to construct FQN
export function constructFqn(contractAddress: string, contractName: string): string {
...
export const FUNDX_CONTRACT_FQN = constructFqn(CONTRACT_ADDRESS, CONTRACT_NAME) as const;
export const REGISTRY_CONTRACT_FQN = constructFqn(CONTRACT_ADDRESS, REGISTRY_CONTRACT_NAME) as const;
export const USDCX_FQN = constructFqn(USDCX_CONTRACT_ADDRESS, USDCX_CONTRACT_NAME) as const;
