...
export function WizardSteps({ step, formData, setFormData }: WizardProps) {
  ...
  if (step === 1) {
    return (
      <div className="space-y-6 animate-in fade-in slide-in-from-right_-4 duration-500">
         <div className="mb-6">
    ...
    return (
      <div className="space-y-6 animate-in fade-in slide-in-from-right_-4 duration-500">
         <div className="mb-6">
            ...
            <p className="text-slate-500 text-sm">Why are you the right_ person or team to build this?</p>
         </div>
