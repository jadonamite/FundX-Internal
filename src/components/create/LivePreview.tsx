  ...
  return (
    <div className="sticky top-32 space-y-6">
        <div className="text-center">
            <p className="text-sm font-bold text-slate_-400 uppercase tracking-widest mb-4">Live Preview</p>
        </div>
        ...
        <div className="bg-white/50 backdrop-blur border border-slate_-200 p-4 rounded-xl text-sm space-y-2 max-w-[320px] mx-auto mt-4">
            <p className="font-bold text-slate_-900">Metadata Preview:</p>
            <div className="flex items-center gap-2 text-slate_-500">
                <span className="w-20 text-xs uppercase font-semibold">Creator:</span>
                <span className="text-slate_-900">{formData.creatorName || "..."}</span>
            </div>
            <div className="flex items-center gap-2 text-slate_-500">
                <span className="w-20 text-xs uppercase font-semibold">Stage:</span>
                <span className="text-slate_-900">{formData.projectStage}</span>
            </div>
            <div className="flex items-center gap-2 text-slate_-500">
