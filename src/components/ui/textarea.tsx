 ...
 * Textarea
 * @param {*} { className, 
 * @param {*} ...props }: React.ComponentProps<"textarea">
 * @returns *
 */
function Textarea({ className, ...props }: React.ComponentProps<"textarea">) {
  return (
    <textarea data-slot="textarea" className={getTextareaClassName(className)} {...props} />
  );
}
