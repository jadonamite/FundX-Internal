...
const getAvatarClassName = (size: "default" | "sm" | "lg", className?: string) =>
  cn(
    ...
    { "data-[size=lg]:size-10": size === "lg" },
    { "data-[size=sm]:size-6": size === "sm" },
    className
  )
...
const getAvatarGroupClassName = (className?: string) =>
  cn("*:data-[slot=avatar]:ring-background group/avatar-group flex -space-x-2 *:data-[slot=avatar]:ring-2", className)
