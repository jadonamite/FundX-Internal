...
const getSelectTriggerClasses = (size: "sm" | "default", className?: string) =>
  cn(
...
const getSelectContentClasses = (position: "item-aligned" | "popper", className?: string) =>
  cn(
...
function SelectTrigger({ className, size = "default", children, ...props }: React.ComponentProps<typeof SelectPrimitive.Trigger> & { size?: "sm" | "default" }) {
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={getSelectTriggerClasses(size, className)}
      {...props}
    >
      {children}
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={getSelectContentClasses(position, className)}
        position={position}
        align={align}
        {...props}
      >
