...
const getDropdownMenuItemClasses = (variant: string, inset: boolean, className: string) =>
  cn(
    ...
    { "data-[variant=destructive]:text-destructive": variant === "destructive" },
    { "data-[variant=destructive]:focus:bg-destructive/10": variant === "destructive" },
    { "dark:data-[variant=destructive]:focus:bg-destructive/20": variant === "destructive" },
    { "data-[variant=destructive]:focus:text-destructive": variant === "destructive" },
...
function DropdownMenuItem({ className, inset, variant = "default", ...props }: React.ComponentProps<typeof DropdownMenuPrimitive.Item> & { inset?: boolean; variant?: "default" | "destructive" }) {
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={getDropdownMenuItemClasses(variant, inset, className)}
      {...props}
    />
  )
}
