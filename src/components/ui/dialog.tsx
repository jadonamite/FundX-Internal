...
function DialogOverlay({ className, ...props }: React.ComponentProps<typeof DialogPrimitive.Overlay>) {
  return (
    <DialogPrimitive.Overlay data-slot='dialog-overlay' className={getDialogOverlayClass(className)} {...props} />
  )}
...
function DialogContent({
  ...
  return (
    <DialogPortal data-slot='dialog-portal'>
      <DialogOverlay />
      <DialogPrimitive.Content data-slot='dialog-content' className={getDialogContentClass(className)} {...props}>
        {children}
        {showCloseButton && (
