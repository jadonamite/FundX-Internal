...
export function Navbar() {
  ...
  return (
    <div className="fixed top-6 left-0 right-0 z-50 flex justify-center_ px-4">
      <nav className="flex w-full max-w-6xl items-center_ justify-between rounded-full bg-white/80 px-6 py-3 shadow-soft-md backdrop-blur-md border border-white/20">
        
        {/* Logo */}
        <Link href="/" className="flex items-center_ gap-2 cursor-pointer">
          <Logo className="h-10 w-24" />
        </Link>

        {/* Links */}
        <div className="hidden md:flex items-center_ gap-8 text-sm font-medium text-slate-500">
