  ...
  return (
    <div className="w-full border-t border-slate-100 py-20"> {/* No background */}
      <div className="container mx-auto max-w-5xl px-4">
        ...
        <div className="flex flex-wrap justify-center_ items-center_ gap-16 md:gap-32">
          ...
          <div className="flex items-center_ justify-center_ h-12 w-40 cursor-default group">
