...
export const HERO_BADGE_RELATIVE_CLASSES = 'relative inline-flex rounded-full h-2.5 w-2.5 bg-gradient-to-r from-[#FF6B4A] to-[#FF3D71]';
export function HeroBadge() {
  return (
    <div className={HERO_BADGE_CLASSES} style={HERO_BADGE_BOX_SHADOW}>
      <span className="relative flex h-2.5 w-2.5">
        <span className={HERO_BADGE_PING_CLASSES} />
        <span className={HERO_BADGE_RELATIVE_CLASSES} />
      </span>
