export function HeroBadge() {
  ...
  const badgeIconClasses = "relative inline-flex rounded-full h-2.5 w-2.5 bg-gradient-to-r from-[#FF6B4A] to-[#FF3D71]";
  ...
  return (
    <div className={badgeClasses} style={badgeStyles}>
      ...
      <span className={badgeTextClasses}>Live on Stacks</span>
    </div>
  )
}