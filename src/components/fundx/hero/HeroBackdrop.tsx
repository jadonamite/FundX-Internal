...
function calculateLogoStyles(mouseOffset, currentMouse, progress, oscillateX, oscillateY) {
  ...
  useEffect(() => {
    ...
    function startAnimation() {
      function animate(time: number) {
        ...
        const styles = calculateLogoStyles(mouseOffset.current, currentMouse.current, progress, oscillateX, oscillateY)
