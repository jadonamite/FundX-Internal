...
const getIconStyle = ({ displayStacks, glitching }: { displayStacks: boolean; glitching: boolean }) => ({
  position: "absolute",
  opacity: displayStacks ? 1 : 0,
  transition: glitching ? "none" : "opacity 300ms ease",
})

const getBitcoinIconStyle = ({ displayStacks, glitching }: { displayStacks: boolean; glitching: boolean }) => ({
  position: "absolute",
  opacity: !displayStacks ? 1 : 0,
  transition: glitching ? "none" : "opacity 300ms ease",
})
