...
export function ChainToggleIcon({
  ...
  const glitchStyle = {
    ...
    ...(glitching
      ...
      : { transform: `translate(0px, 0px) skewX(0deg) rotate(${isStacksMode ? "6deg" : "-6deg"})`, transition: "transform 700ms cubic-bezier(0.4,0,0.2,1), background-color 600ms ease_, box-shadow 600ms ease_, opacity 300ms ease_" }),
