...
export function ChainToggleIcon({
  ...
  const absoluteSpanStyle = getAbsoluteSpanStyle(
    displayStacks,
    glitching
  )
  const absoluteSvgStyle = getAbsoluteSvgStyle(
    displayStacks,
    glitching
  )
