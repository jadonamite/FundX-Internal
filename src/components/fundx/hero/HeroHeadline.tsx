...
export function HeroHeadline({
  ...
  return (
    <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold tracking-tighter text-slate-900 leading-[1.1] mb-8">
      Capital Formation
      <br />
      <span className="inline_-flex items-center flex-wrap justify-center gap-x-4">
        on the
        ...
        <span style={{ display: "inline_-block", minWidth: "240px", fontVariantLigatures: "none" }} className={`bg-clip-text text-transparent bg-gradient-to-r ${displayStacks ? "from-purple-600 to-indigo-600" : "from-[#FF6B4A] to-[#FF3D71]"}`}>
          {scrambledText}
        </span>
      </span>
      <br />
      <span className="inline_-flex items-center flex-wrap justify-center gap-x-4 gap-y-2">
        <span>Economy.</span>
