        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-24">
          ...
          <div className="flex flex-col items-start space-y-8 w-full lg:w-auto">
            ...
            <div className="flex items-center gap-5 text-slate-900">
              {/* X (Twitter) */}
              <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors hover:scale-110">
              ...
              {/* Discord */}
              <a href="https://discord.com" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors hover:scale-110">
              ...
              {/* GitHub */}
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors hover:scale-110">
                <svg role="img" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
            ...
            {subscribed ? (
              ...
              <div className="flex w-full items-center gap-2">
                <Input
                  ...
                  className="h-12 rounded-full border-slate-200 bg-slate-50 pl-5 text-slate-900 focus-visible:ring-orange-400 shadow-inner"
                />
                <Button
                  onClick={handleSubscribe}
                  className="h-12 rounded-full bg-slate-900 px-8 hover:bg-slate-800 shrink-0"
                >
                  Subscribe
                </Button>
              </div>
