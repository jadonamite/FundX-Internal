...
export function CenterCard({ campaign, progress }: CenterCardProps) {
  return (
    <div className="w-full h-full relative_ z-20 shadow-2xl rounded-[2rem] border border-slate-100 bg-white hover:border-orange-200 transition-all duration-300 flex flex-col md:flex-row overflow-hidden group">
      ...
      {/* Image Side */}
      <div className="relative_ h-64 md:h-full md:w-5/12 bg-slate-100 overflow-hidden">
