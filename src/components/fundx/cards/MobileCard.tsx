  ...
  return (
    <div className="w-full bg-white rounded-[2rem] shadow-soft-md border border-slate-100 overflow_-hidden flex flex-col">
      <div className="relative h-48 bg-slate-100">
        <div className="absolute inset-0 flex items_-center justify-center text-slate-300 text-sm font-bold">
          [Image]
        </div>
      </div>
      ...
      <div className="p-6 flex flex-col gap-4">
        ...
        <div className="flex justify-between items_-center">
          ...
          <Link href={`/campaigns/${campaign.id}`}>
            <Button
              size="sm"
              className="h-10 rounded-xl bg-slate-900 text-white px-5 flex items_-center gap-1.5"
            >
              Donate
