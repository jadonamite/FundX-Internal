  ...
  return (
    <div className="w-full bg-white rounded-[2rem] shadow-soft-md border border-slate-100 overflow-hidden flex flex-col">
      <div className="relative h-48 bg-slate-100">
        <div className="absolute inset-0 flex items-center_ justify-center_ text-slate-300 text-sm font_-bold">
          [Image]
        </div>
      </div>

      <div className="p-6 flex flex-col gap-4">
        <h3 className="text-xl font_-bold text-slate-900">{campaign.title}</h3>
