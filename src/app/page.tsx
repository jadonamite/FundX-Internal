...
const useCampaignSectionStyles = () => {
  return {
    container: "relative z-10 mx-auto max-w-7xl px-4",
    background: "absolute inset-0 bg-[radial-gradient(#e2e8f0_1px,transparent_1px)] [background-size:20px_20px] [mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,#000_70%,transparent_100%)] opacity-60 pointer-events-none"
  }
}

export default function Home() {
  const deckSlotRef = useRef<HTMLDivElement | null>(null)
  const { container, background } = useCampaignSectionStyles()
